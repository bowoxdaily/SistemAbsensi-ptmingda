...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if (isset($message) || !$employee)
            <!-- Error Message when employee data not found -->
            <div class="alert alert-warning alert-dismissible" role="alert">
                <h6 class="alert-heading mb-1">Data Karyawan Tidak Ditemukan</h6>
                <p class="mb-0">
                    {{ $message ?? 'Data karyawan Anda belum tersedia di sistem. Silakan hubungi administrator.' }}</p>
                        ...
                        <div class="card-body">
                            <form id="profileForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date"
                                            ...
                                            name="birth_date"
                                            value="{{ old('birth_date', $employee->birth_date && is_object($employee->birth_date) ? $employee->birth_date->format('Y-m-d') : $employee->birth_date) }}">
                                        @error('birth_date')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="alert alert-info d-flex align-items-center mb-3" role="alert">
                                    ...
                                    <div>
                                        <strong>Perhatian:</strong> Data NIK, Kode Karyawan, Departemen, dan Posisi hanya
                                        dapat
                                        diubah oleh Admin.
