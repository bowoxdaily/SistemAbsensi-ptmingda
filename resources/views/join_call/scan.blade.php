...
<head>
    ...
    <title>Panggilan Join Check-in - {{ config('app.name') }}</title>
...
<body>
    <div class="scan-card">
        <div class="scan-header">
            ...
            <h3 class="mb-0">Panggilan Join Check-in</h3>
        ...
        <div class="scan-body">
            @if(!$joinCall->isCheckedIn())
                ...
                <div class="qr-code-section">
                    ...
                    <div class="qr-code-container">
                        <img src="{{ $joinCall->qr_code_image }}" alt="QR Code" id="qrCodeImage">
                    </div>
            ...
            @if($joinCall->isCheckedIn())
                <div class="checked-in-info">
                    ...
                    <p class="mb-1">
                        <strong>{{ $joinCall->checked_in_at->format('d/m/Y H:i') }}</strong>
                    </p>
                    <small class="text-muted">Oleh: {{ $joinCall->checked_in_by }}</small>
                </div>
            @endif
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $joinCall->join_call_time->format('H:i') }} WIB</div>
            </div>
            
            <div class="info-row">
                <div class="info-label">Lokasi</div>
                <div class="info-value">{{ $joinCall->location }}</div>
            </div>
            ...
            <div class="info-row">
                ...
                <div class="info-value">
                    @php
                        ...
                        if($joinCall->status === 'confirmed') {
                            $statusClass = 'status-confirmed';
                            $statusText = 'Terkonfirmasi';
                        } elseif($joinCall->status === 'completed') {
                            $statusClass = 'status-completed';
                            $statusText = 'Selesai';
                        } elseif($joinCall->status === 'cancelled') {
